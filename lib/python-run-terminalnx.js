...
module.exports = {
    ...
    config: {
        a_terminal_selection: {
          ...
          description: "Linux terminal emulators supported are `gnome-terminal, konsole, terminator, xterm and uxterm`",
          type: "string",
...
function run() {
    ...
    var supported_terminals = ["gnome-terminal", "konsole", "terminator", "xterm", "uxterm"];
    ...
    if (sel_term != "gnome-terminal" && sel_term != "terminator") {
       var ex_op = "-e";
    }

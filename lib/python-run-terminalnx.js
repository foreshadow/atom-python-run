...
module.exports = {
    ...
    config: {
      a_terminal_selection: {
        ...
        description: "For Windows, select `cmd` and for Linux, select the compatible terminal emulators like `gnome-terminal, konsole, xfce4-terminal, deepin-terminal and terminator`",
        type: "string",
        default: "cmd",
        enum: [
